...
<h1>Add Text Input</h1>
    <div id="inputContainer">
        <!-- Existing input fields will be displayed here -->
    </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            // Handle the session variable value
            ...
            console.log("Session variable value:", response);
        },
...
<table>
	...
	<tr>
		...
		<a href="#" onClick="window.open('serachForms/employeesearch.php','ChildWindow','status=no','menubar=no','location=no','resizable=no','scrollbars=no','1','width =500,height=500')"><i class="ri-search-2-line"></i></a>
...
<tr>
	...
	<tr>
		...
		if (isset($_SESSION['section']) && $_SESSION['section'] == true) {
    		...
    		echo '<input type="text"  value= "' . $sec . '" name="submit" ';
        ...
        <tbody id="showdata">
		 ...
		 <script>
		  $(document).ready(function(){
		   $('#getName').on("focus", function(){
		     var getName = $(this).val();
		     $.ajax({
		       method:'POST',
		       url:'testedit.php?id=1',
		       data:{name:getName},
		       success:function(response)
		       {
