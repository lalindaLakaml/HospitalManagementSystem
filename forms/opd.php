...
?>
    ...
    <section class="main">
        ...
        <div class="main--content" id= "con">
           ...
           <form name = "frmMain" id = "frmMain"  action = "..\dbupdate\createopd_update.php"  method = "post">
				<table>	
					<tr >
						<th colspan="2">OPD Ticket</th>
						
					</tr>
					<tr>
						<td style="width: 165px">OPD ID :</td>
						<td><?php
						include '../dbupdate/dbcon.php';
						
						$sql = "SELECT MAX(`Opd_ID`) AS id FROM `opd`";
					...
					<tr>
						<td>Patient ID :</td>
						<td><input type="text"  name="patid" id="patid" required readonly><a href="#" onClick="searchClick();"><i class="ri-search-2-line"></i></td>
					</tr>
						
					<tr>
						<td style="width: 165px">Patient Name :</td>
						<td><input type="text" size="70" name="patname" id="patname" value="" readonly></td>
					</tr>
					
					<tr>
						<td style="width: 165px">Heaight :</td>
						<td><input type="number" name="hei" id="hei" value="" ></td>
					</tr>


					<tr>
						<td style="width: 165px">Weight :</td>
						<td><input type="number" name="wei" id="wei" value="" ></td>
					</tr>
					
					<tr>
						<td style="width: 165px">Temperature :</td>
						<td><input type="number" name="tem" id="tem" value="" ></td>
					</tr>
