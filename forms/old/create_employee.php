...
<table>
	...
	<tr>
		...
		<a href="#" onClick="window.open('forms/serachForms/employeesearch.php','status=no','menubar=no','location=no','resizable=no','scrollbars=no','1','width =500,height=500')"><i class="ri-search-2-line"></i></a>
	...
	<tr>
		...
		<tr>
		<td>Last Name :</td>
		<td><input type="text"  name="lname" size="50" required><br></td>
	</tr>
