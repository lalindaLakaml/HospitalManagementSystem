...
<table>
	...
	<tr>
		...
		<a href="#" onClick="window.open('forms/serachForms/hospitalsearch.php','status=no','menubar=no','location=no','resizable=no','scrollbars=no','1','width =500,height=500')"><i class="ri-search-2-line"></i></a>
